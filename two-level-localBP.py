# -*- coding: utf-8 -*-
"""
Created on Mon Nov  6 16:06:22 2017
...
phtsize = input("Please enter the pattern history table size(bits): ")
x=2**int(phtsize)
print("Reading file")
...
while i<len(result1):
    ...
    k=int(("".join(str(x) for y in lhr[modaddr])),2)
...
print("total entries: "+str(len(result1))+"\n")
print("total misses: "+str(j)+"\n")
